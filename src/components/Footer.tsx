        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-20">
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <SocialLink icon={<Users className="w-6 h-6" />} href="#" />
              <SocialLink icon={<Globe className="w-6 h-6" />} href="#" />
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-500 font-bold">
              ...
              <li><Link href="/wiki" className="hover:text-[#06C167] transition-colors">Guide</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-500 font-bold">
              <li><Link href="#" className="hover:text-[#06C167] transition-colors">Confidentialité</Link></li>
              <li><Link href="#" className="hover:text-[#06C167] transition-colors">CGV</Link></li>
              <li><Link href="#" className="hover:text-[#06C167] transition-colors">Mentions</Link></li>
            </ul>
          </div>
        </div>

        <div className="pt-12 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-6 text-sm font-bold text-slate-400 uppercase tracking-widest">
